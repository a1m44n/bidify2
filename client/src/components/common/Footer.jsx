    ...
    <footer className="relative bg-primary py-16 mt-16">
      ...
      <Container className={`${isHomePage ? "mt-32" : "mt-0"} flex flex-col md:flex-row justify-between gap-12`}>
        <div className="w-full md:w-1/3">
          ...
          <br />
          <p className="text-gray-300">Your go-to platform for buying and selling items.</p>
          <div className="bg-gray-300 h-[1px] my-8"></div>
          <Title className="font-normal text-gray-100">Get The Latest Bidify Updates</Title>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 mt-8 text-gray-200">
              <div className="flex items-center gap-2">
                ...
                <span>(011) 3998-0035</span>
              </div>
              <div className="flex items-center gap-2">
                <MdOutlineAttachEmail size={22} />
                <span>aiman@bidify.com</span>
              </div>
              <div className="flex items-center gap-2">
                <IoLocationOutline size={22} />
                <span>JC 2164, LKP6, TAMAN LIPAT KAJANG PERDANA</span>
              </div>
            </ul>
