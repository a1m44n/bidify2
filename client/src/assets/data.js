  ...
  export const processList = [
    {
      id: "01",
      title: "Sign up",
      desc: "Sign up via and create an account on the website. Snap some pictures, describe the item and set a starting price.",
      cover: "https://rainbowthemes.net/themes/nuron/wp-content/uploads/2023/01/shape-7.png",
    },
    {
      id: "02",
      title: "Auction goes online",
      desc: "List the item up and let the bidding commence.",
      cover: "https://rainbowthemes.net/themes/nuron/wp-content/uploads/2023/09/auction.png",
    },
    {
      id: "03",
      title: "Closing auction",
      desc: "After the item is sold to the highest bidder, the bidder and seller can get in contact with each other to arrange the payment and delivery of the item.",
